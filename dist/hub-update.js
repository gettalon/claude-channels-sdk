...
export function installUpdate(Hub) {
        ...
        try {
            ...
            for (let i = 0; i < 5; i++) {
                try {
                    ...
                    if (pkg.name === "@gettalon/channels-sdk")
                        return pkg.version;
                }
                catch { /* keep walking */ }
                dir = dirname(dir);
     ...
     */
    Hub.prototype.checkForUpdates = async function () {
     ...
     */
    Hub.prototype.autoUpdate = async function () {
...
//# sourceMappingURL=hub-update.js.map