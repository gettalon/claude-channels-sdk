...
async function main() {
    ...
    switch (transport) {
        ...
        default:
            ...
            if (PLATFORM_CHANNELS.includes(transport)) {
...
async function startStdio() {
    const channel = new ChannelServer({
        name: "talon-channels",
        version: "1.2.0",
        instructions: 'Messages arrive as <channel source="talon-channels" chat_id="..." user="...">. ' +
...
async function startPlatformChannel(name) {
