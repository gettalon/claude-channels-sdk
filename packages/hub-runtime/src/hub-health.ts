 ...
 */
import type { HealthSnapshot } from "@gettalon/hub-core";

/** Install health monitor methods onto the hub class prototype. */
export function installHealth(Hub: any): void {

  /** Return a point-in-time health snapshot (no side effects). */
  Hub.prototype.getHealth = async function(this: any): Promise<HealthSnapshot> {
   ...
   */
  Hub.prototype.startHealthMonitor = function(this: any, intervalMs = 30000): void {
  ...
  Hub.prototype.stopHealthMonitor = function(this: any): void {
