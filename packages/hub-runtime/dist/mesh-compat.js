...
export class E2eSession {
    static fromKeyExchange(_privateKey, _publicKey, _name) {
        throw new Error("E2eSession not available — mesh module not loaded");
    }
    encrypt(_data) { throw new Error("E2eSession not available"); }
    decrypt(_data) { throw new Error("E2eSession not available"); }
}
export async function loadOrCreateIdentity(_dir) {
    throw new Error("loadOrCreateIdentity not available — mesh module not loaded");
}
//# sourceMappingURL=mesh-compat.js.map