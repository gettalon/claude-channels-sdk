...
export const sendMessageTool: ToolDefinition = {
  ...
  handle: async (args, ctx) => {
    ...
    if (args.tts) rich.meta = { ...(rich.meta as any), tts: "true", tts_voice: args.tts_voice };
    const r = ctx.hub.sendMessage(args.agent_id as string, args.content as string, Object.keys(rich).length ? rich as any : undefined);
